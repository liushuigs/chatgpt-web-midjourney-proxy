...
<template>
  <section class="mb-4 flex justify-between items-center">
    ...
    <NSelect v-model:value="nGptStore.model" :options="modellist" size="small" class="!w-[50%]" />
  </section>
  <section class="mb-4 flex justify-between items-center">
    <NInput v-model:value="nGptStore.userModel" :placeholder="$t('mjchat.modlePlaceholder')">
      <template #prefix>
        {{ $t('mjchat.myModle') }}
      </template>
    </NInput>
  ...
  <section class=" text-right flex justify-end space-x-2">
    ...
    <NButton type="primary" @click="saveChat">
      {{ $t('mj.setBtSaveChat') }}
    </NButton>
